...
def decrypt_password():
	# tells program what to write depending on a line in a file
	descriptions = {1: "platform: ", 2: "username: ", 3: "password: "}
...
# key is equal to master password combined with a key
